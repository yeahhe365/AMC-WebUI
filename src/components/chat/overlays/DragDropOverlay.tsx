...
export const DragDropOverlay: React.FC<DragDropOverlayProps> = ({ isDraggingOver }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[color-mix(in_srgb,var(--theme-bg-accent)_20%,transparent)] backdrop-blur-xs flex flex-col items-center justify-center pointer-events-none z-50 border-4 border-dashed border-[var(--theme-bg-accent)] rounded-lg m-1 sm:m-2 drag-overlay-animate">
