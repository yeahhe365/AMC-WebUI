...
<ThemeImage
  ...
  dark={appPreviewDark}
  alt="AMC WebUI 控制台界面预览，展示模型成本对比对话、Python 代码块与结果表格"
  label="AMC WebUI · 模型控制台"
/>

<p class="home-eyebrow">核心能力</p>
...
<div class="feature-grid">
  <HomeFeatureCard
    icon="open-book"
    title="深度思维链 (Thinking)"
    href="/models/thinking/"
    linkText="查看思考模式配置与翻译指南"
  >
  ...
  <HomeFeatureCard
    ...
    href="/models/live-api/"
    linkText="探索实时双向音视频通话"
  >
    双向低延迟语音通话、摄像头画面捕获、屏幕共享与基于 AudioWorklet 的实时音频波形渲染。
  </HomeFeatureCard>
  <HomeFeatureCard
    icon="puzzle"
    title="交互式构件 (Live Artifacts)"
    href="/tools/live-artifacts/"
    linkText="体验图表沙箱与可视化渲染"
  >
    代码块自动识别为全屏 HTML/SVG 交互沙箱，内置 Apache ECharts、Mermaid 与 Graphviz 多引擎图表直出。
  </HomeFeatureCard>
  <HomeFeatureCard
    icon="setting"
    title="本地 Python 沙箱 (Pyodide)"
    href="/tools/code-and-sandbox/"
    linkText="了解零服务器算力本地 Python"
  >
